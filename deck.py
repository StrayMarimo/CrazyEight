...
class Deck:
    ...
    def set_deck(self, cards_data):
        self.__deck = [Card(card['__suit'], card['__rank'], card['__value']) for card in cards_data]
class Card:
...
class Hand:
    ...
    def set_cards_in_hand(self, cards_data):
        self.__cards_in_hand = [Card(card['__suit'], card['__rank'], card['__value']) for card in cards_data]
...
class DiscardPile:
    ...
    def set_cards_in_discard_pile(self, cards_data, top_card):
        self.__cards_in_discard_pile = [Card(card['__suit'], card['__rank'], card['__value']) for card in cards_data]
        self.__top_card = Card(top_card['__suit'], top_card['__rank'], top_card['__value'])
